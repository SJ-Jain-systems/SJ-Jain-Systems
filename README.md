...
- **Mitski Lyrics Over Time** is a computational text analysis project that quantifies lexical change across Mitski's seven studio albums, combining a custom Genius scraper, length-robust diversity metrics, weighted log-odds keyness, and AFINN sentiment scoring in a reproducible Quarto pipeline to show her lyrics grow leaner yet more lexically diverse over time.
## Personal Interests
