...
- - **Table Tennis Serve Analysis** A data science project that predicts point outcomes from previous information and recommends serve strategies by opponent style, game state, and score pressure. Built on 500 point-level observations from my own matches as a competitive table tennis player.
## Personal Interests
