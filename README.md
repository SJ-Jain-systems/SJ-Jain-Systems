...
- **Table Tennis Serve Analysis** A data science project that predicts point outcomes from pre-serve information and recommends serve strategies by opponent style, game state, and score pressure. Built on 500 point-level observations from my own competitive matches as a ~1910 Elo table tennis player.

## Personal Interests
Table Tennis (1910 elo), NCAA FolkStyle Wrestling, Federal Reserve Simulator Enthusiast
